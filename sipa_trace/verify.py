"""Recompute the hash chain from scratch. Run it against a log you did not
produce and it still tells you whether the record is intact."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not argv:
        print("usage: python -m sipa_trace.verify <log.jsonl>")
        return 2
    res = verify(argv[0])
